...
#Populate Dataset
filtered_survey %>% select(vote_2020, age, agegroup, gender, state, employment, race, education) -> survey

#create cells
survey$cell <- paste(survey$gender, survey$race)

#convert var to factors
factor.survey <- c("agegroup", "gender", "education", "employment", "state", "race", "cell", "vote_2020")
